...
class ProtocolMessageTypes(Enum):
    ...
    request_plots = 67 + 6
    respond_plots = 68 + 6
    plot_sync_start = 78 + 6
    plot_sync_loaded = 79 + 6
    plot_sync_removed = 80 + 6
    plot_sync_invalid = 81 + 6
    plot_sync_keys_missing = 82 + 6
    plot_sync_duplicates = 83 + 6
    plot_sync_done = 84 + 6
    plot_sync_response = 85 + 6

    # More wallet protocol
    coin_state_update = 69 + 6
    register_interest_in_puzzle_hash = 70 + 6
    respond_to_ph_update = 71 + 6
    register_interest_in_coin = 72 + 6
    respond_to_coin_update = 73 + 6
    request_children = 74 + 6
    respond_children = 75 + 6
    request_ses_hashes = 76 + 6
    respond_ses_hashes = 77 + 6
